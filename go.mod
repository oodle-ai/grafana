...
require (
	...
	github.com/grafana/alerting v0.0.0-20251120161053-ee90fc928c01 // @grafana/alerting-backend
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp v1.38.0 // @grafana/grafana-backend-group
